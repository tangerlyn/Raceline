misys@AIX-411-UBUNTU-22:~/f1tenth_ws$ cat src/lqr_pid/src/lqr_pid_node.cpp 
...
LQRPID::LQRPID() : Node("lqr_pid_node") {
    ...
    this->declare_parameter("lqr_q_y", 100.0);
    this->declare_parameter("lqr_q_yaw", 100.0);
